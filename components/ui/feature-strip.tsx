...
<div className="hidden md:flex md:justify-center md:items-st md:py-0 md:px-0">
  {/* 1st block */}
  <div className="text-center flex-1 px-2 transition-all duration-300 cursor-pointer hover:scale-105 hover:!text-[#FFD200] hover:drop-shadow-[0_0_20px_rgba(255,210,0,0.6)] px-4 py-4 text-white group">
    ...
    <h3 className="text-white hover:!text-[#FFD200] text-h3 font-heading tracking-tight mb-1 transition-colors">
      World-Class Infrastructure
    </h3>
    <p className="text-white hover:!text-[#FFD200] text-sm leading-snug max-w-xs mx-auto transition-colors">
      Modern classrooms, advanced labs, rich library, and smart learning tools.
    </p>
  </div>
