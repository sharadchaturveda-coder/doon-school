...
export default function FeatureStrip() {
  return (
    <section className="relative text-white">
      ...
      <div className="absolute inset-0 bg-[url('/images/classroom/classroom.webp')] bg-cover bg-center"></div>
        ...
        <div className="grid gap-3 lg:hidden">
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-xl p-4 border border-white/20 shadow-lg">
            <div className="text-center space-y-2">
              ...
              <div>
                <h3 className="text-white text-lg font-bold tracking-tight mb-1">World-Class Infrastructure</h3>
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-xl p-4 border border-white/20 shadow-lg">
            <div className="text-center space-y-2">
              ...
              <div>
                <h3 className="text-white text-lg font-bold tracking-tight mb-1">Residential & Day Boarding Facilities</h3>
                <p className="text-sm text-white/90 leading-tight">
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-xl p-4 border border-white/20 shadow-lg">
            <div className="text-center space-y-2">
              ...
              <div>
                <h3 className="text-white text-lg font-bold tracking-tight mb-1">Sports & Extracurricular Activities</h3>
                <p className="text-sm text-white/90 leading-tight">
